...
import CallCenterUserNav from "../components/navbars/CallCenterUserNav";

const CallCenterUserLayout = () => {
  ...
  useEffect(() => {
    ...
    } else if (!token || role !== "CALL_CENTER_USER") {
...
export default CallCenterUserLayout;
